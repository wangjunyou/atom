...
public class Http3Test {
    ...
    public void test() throws IOException, InterruptedException {
        ...
        props.load(new FileInputStream("/home/jocker/opt/workspaces/git/atom/libs/atom-http/src/test/resources/atom.properties"));
        Injector injector = Guice.createInjector(new ConfigModule(props), new HttpModule("com.wjy.atom.http"));
